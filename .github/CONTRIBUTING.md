Thanks for contributing to `_s` (Special Theme) — you rock!
...
If your issue is specific to the [Special Theme.me](http://underscores.me) website, the [Special Theme.me GitHub repo](https://github.com/Automattic/underscores.me) is the right place for you.

The preferred method of generating a new theme based on `_s` is the [Special Theme.me](http://underscores.me) website. If you have an alternative method, such as a shell script, write a blog post about it or host it in a separate repo -- and make sure to mention [@underscoresme](https://twitter.com/underscoresme) in your tweets!
